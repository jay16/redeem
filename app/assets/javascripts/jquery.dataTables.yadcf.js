...
*/
	...
	function init(oTable, options_arg, filters_position) {
        ...
        filterInput.addClass('form-control input-sm').parent().addClass('input-group');
        filterReset.addClass('btn btn-default btn-sm').html('<i class="fa fa-times"></i>').wrap('<span class="input-group-btn"></span>');			
	}
